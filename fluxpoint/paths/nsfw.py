...
class NSFW(BaseHTTP):
    ...
    async def azurlane_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def feet_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def cum_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def blowjob_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
        Returns a random nsfw blowjob image/gif
    ...
    async def solo_girl_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def neko_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def boobs_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def anal_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def pussy_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def yuri_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def bdsm_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def futa_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def hentai_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def spank_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def ass_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def kitsune_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def femdom_nsfw(self, gif: Optional[bool] = False) -> Union[URL, str]:
        """
    ...
    async def nekopara_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def lewd_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def pantyhose_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def cosplay_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def petplay_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def gasm_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def ahego_nsfw(self) -> Union[URL, str]:
        """
        Returns a random nsfw ahego image
    ...
    async def trap_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def anus_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def holo_nsfw(self) -> Union[URL, str]:
        """
    ...
    async def yaoi_nsfw(self) -> Union[URL, str]:
        """
